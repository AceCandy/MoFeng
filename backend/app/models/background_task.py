...
from sqlalchemy import BigInteger, DateTime, ForeignKey, Index, Integer, JSON, String, Text, func, text
...
class BackgroundTask(Base):
    ...
    executor_generation: Mapped[int] = mapped_column(Integer, nullable=False, default=1, server_default="1")
    stream_type: Mapped[str] = mapped_column(String(32), nullable=False, default="job", server_default="job")
